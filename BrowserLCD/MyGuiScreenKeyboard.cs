...
namespace avaness.BrowserLCD
{
    public class MyGuiScreenKeyboard : MyGuiScreenBase
    {
        ...
        public MyGuiScreenKeyboard(Vector2 browserId) : base(new Vector2?(new Vector2(0.5f, 0.9f)), new Vector4?(MyGuiConstants.SCREEN_BACKGROUND_COLOR), new Vector2?(new Vector2(0.497142851f, 0.280534357f)), false, null, MySandboxGame.Config.UIBkOpacity, MySandboxGame.Config.UIOpacity, null)
        {
            ...
            base.AddCaption("Virtual Keyboard - Esc to close", null, new Vector2?(new Vector2(0f, 0.003f)), 0.8f);
            ...
            float y = -0.027f;
            this.m_nameTextbox = new MagicTextbox(new Vector2?(new Vector2(0f, y)), "", 75, null, 0.8f, MyGuiControlTextboxType.Normal, MyGuiControlTextboxStyleEnum.Default);
            ...
            Vector2 value = new Vector2(0.002f, this.m_size.Value.Y / 2f - 0.045f);
            ...
            this.m_cancelButton.CanHaveFocus = false;
